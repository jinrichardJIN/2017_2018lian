<template>
	<div>
		...
		<header class="mobAll-top">
			<router-link :to="{name: 'selectCity'}" class="mob-city-box">
			...
			<div class="mui-input-row mui-search">
				<router-link :to="{name: 'searchModel',query:{searchReturn:'index.mobAll'}}" class="mob-input-box">
		...
		<div class="mob-content">
			<div class="mob-con-left" id="inccc">
				<div class="mob-left segmentedControls" :class="{'moball-active':selectCategoryId==category.id}"  @click="selectCategory(category.id)" v-for="(category,index) in CategoryList" :key="category" >
					<router-link :to="{name: 'index.mobAll' }" class="mui-control-item ">
				...
				<div class="mob-right">
					<ul>
						<li class="mob-rig-img" v-for="imgUrl in brandList">
							<router-link :to="{name: 'goodsList',query:{brandId:imgUrl.brandId} }" class="mui-control-item ">
