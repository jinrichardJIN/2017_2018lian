<template>
	<div>
		...
		<div class="mui-content">
			...
			<div class="mailmessg" v-if="warehouseName">
				<!--<h4>请您在3天内去门店进行交易</h4>-->
				<p >门店营业时间：{{warehouseShopHours}}</p>
				<p >门店回收：{{warehouseName}}</p>
				<p >门店电话：{{warehouseTelephone}}</p>
			</div>
...
<script>
	...
	export default {
		...
		mounted(){
			...
			this.warehouseShopHours = param.warehouseShopHours;
			this.warehouseTelephone = param.warehouseTelephone;
		},
	}
</script>
