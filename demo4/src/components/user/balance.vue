<template>
	<div id="balance">
		<div class="content pagecontent">
			...
			<div class="scroll-content" style="height:67vh; overflow-y: scroll;">
					...
					<div>
						...
						<div v-for='it in list' class="balancelist" @click="godetailinfo(it)"  v-if="list.length>0">
							<div class="bitem">
								...
								<span class="photo">
									<img v-if="it.fundFlowValue=='3'"  src="../../image/push.png">
									<img v-if="it.fundFlowValue=='2'"  src="../../image/recy.png">
								</span>
								<span>
									<span class="money">{{it.inAmt}}</span>
									{{it.coment}}
								</span>
							</div>
						</div>
...
export default {
		...
		methods: {
			...
			getall(me,type){
				...
				var param = {
					from: 'WX',
					maxTime:_this.para.maxTime,
					minTime:_this.para.minTime,
					minAmount:_this.para.minAmount,
					maxAmount:_this.para.maxAmount,
				...
				axios.get(contextPath.contextPath + 'wabindBank/balanceListAndTotal', {
					params: param
				})
				.then(res=> {
					var cData = res.data;
